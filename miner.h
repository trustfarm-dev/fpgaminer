...
#define PACKAGE_NAME "SuperMiner"
#define PACKAGE_VERSION "31337"
...
extern json_t *json_rpc_call(CURL *curl, const char *url, const char *userpass,	const char *rpc_req, int *curl_err, int flags);
...
//void keccak256_midstate(void *output, const void *input);
void keccak256_hash(void *output, const void *input);
int scanhash_keccak256(int thr_id, uint32_t *pdata, const uint32_t *ptarget, uint32_t max_nonce, uint64_t *hashes_done);
